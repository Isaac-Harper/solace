...
A per-player middleground between Survival and Creative, for Fabric on Minecraft 26.1 and 26.2.
...
1. Install [Fabric Loader](https://fabricmc.net/use/) 0.19.3+ for Minecraft 26.1.2 or 26.2 and [Fabric API](https://modrinth.com/mod/fabric-api).
